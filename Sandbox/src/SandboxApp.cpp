...
public:
		...
		: Layer("Example"), m_CameraController(1280.0f / 720.0f)
	{
		...
		squareVB = Hazel::VertexBuffer::Create(svertices, sizeof(svertices));
		...
		m_Texture = Hazel::Texture2D::Create("assets/textures/hq.png");
		m_ChernoLogoTexture = Hazel::Texture2D::Create("assets/textures/clog.png");
